...
public class Settings {
    ...
    public String getURL() {
        return String.format("jdbc:%s://%s:%s/%s",
                formatAttribute(Attributes.TYPE), formatAttribute(Attributes.IP), formatAttribute(Attributes.PORT), formatAttribute(Attributes.DATABASE));
    }
    ...
    public String toString() {
        return String.format("URL: %s; login: %s; password: %s;", this.getURL(), this.getLogin(), this.getPassword());
    }
}
